...
func main() {
	// Input from Day 1
	inputOne, err := readInputOne("inputs/input1.txt")
	if err != nil {
	...
	// Input from Day 2
	inputFullTwo, inputWordsTwo, inputNumsTwo, err := readInputTwo("inputs/input2.txt")
	if err != nil {
	...
	log.Infof("Day 2 - Multiplied position by depth: %v", mult)
}
